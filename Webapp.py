...
pickle_in = open(r'C:\Users\visha\Downloads\Final_trained_model.sav', 'rb')
...
def prediction(income, age, experience, current_house_years, married_single, car_ownership_yes,
               house_ownership_owned, house_ownership_rented):  
   
    prediction = classifier.predict(
        [[income, age, experience, current_house_years, married_single, car_ownership_yes,
               house_ownership_owned, house_ownership_rented]])
    print(prediction)
    return prediction
...
def main():
    ...
    if st.button("Predict"):
        result = prediction(income, age, experience, current_house_years, married_single, car_ownership_yes, house_ownership_owned, house_ownership_rented)
